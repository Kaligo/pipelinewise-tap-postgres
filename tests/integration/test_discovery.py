...
class TestDecimalPK(unittest.TestCase):
    ...
    def test_catalog(self):
        ...
        self.assertEqual({'properties': {'our_decimal': {'multipleOf': 10 ** (0 - post_db.MAX_SCALE),
                                                         'exclusiveMaximum': 10 ** (post_db.MAX_PRECISION - post_db.MAX_SCALE),
                                                         'exclusiveMinimum': -10 ** (post_db.MAX_PRECISION - post_db.MAX_SCALE),
                                                         'type': ['number']},
                                         'our_decimal_10_2': {'exclusiveMaximum': 100000000,
                                                              'exclusiveMinimum': -100000000,
                                                              'multipleOf': 0.01,
                                                              'type': ['null', 'number']},
                                         'our_decimal_38_4': {'exclusiveMaximum': 10000000000000000000000000000000000,
                                                              'exclusiveMinimum': -10000000000000000000000000000000000,
                                                              'multipleOf': 0.0001,
                                                              'type': ['null', 'number']}},
                          'type': 'object',
